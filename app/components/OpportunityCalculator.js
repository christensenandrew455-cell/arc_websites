...
export default function OpportunityCalculator() {
  ...
  return (
    <div className="mx-auto max-w-3xl rounded-[1.75rem] border border-white/10 bg-white p-5 text-slate-950 shadow-2xl shadow-black/30 sm:p-8">
      ...
      <p id="calculator-note" className="mt-4 text-xs leading-5 text-slate-500">
        This shows opportunity value, not guaranteed revenue.
      </p>
    </div>
  );
}

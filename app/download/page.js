...
function DownloadOption({ title, description, href, label }) {
  return (
    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="border-b border-orange-200 bg-gradient-to-b from-orange-50 to-white px-4 py-14 text-center sm:px-6 sm:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Download ARK Client Center on your device.</h1>
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-600">Official Android and iPhone download buttons will become available when the app-store listings are published.</p>
        </div>
      </section>
